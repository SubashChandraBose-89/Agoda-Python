...
class PaymentPage(unittest.TestCase):
    def setUp(self):
    ...
    def test_dayBook(self):
        ...
        try:
            self.driver.find_element(By.XPATH,
                                     "//button[@data-element-name='funnel-switcher' and @data-hh-booking-duration-type='1' and @color='primary']//span[@class='Spanstyled__SpanStyled-sc-16tp9kb-0 kkSkZk kite-js-Span ']").click()
            print("Day Stay Selected")
        except NoSuchElementException:
            self.driver.find_element(By.XPATH,
                                     "//button[@aria-pressed='false' and @data-element-name='funnel-switcher' and @data-hh-booking-duration-type='1']").click()
            print("DayStay Second element found")
        self.city_name = self.wait.until(EC.element_to_be_clickable(self.driver.find_element(By.XPATH,
        ...
        self.date_from = self.driver.find_element(By.XPATH,
                                                  "//span[@class='DayPicker-Day__label'][@data-selenium-date='2023-04-20']")
        ...
        if self.expted_text in self.actual_text:
            print("Booking function is Successful")
        ...
        self.booknow_button = self.wait.until(EC.visibility_of_element_located((By.XPATH,
                                                                                "//button[@class='Buttonstyled__ButtonStyled-sc-5gjk6l-0 jyYkKC'][@data-element-name='time-selector-btn'][1]")))
        ...
        print("hotel selected")
        time.sleep(3)
        self.day_locator = self.wait.until(EC.element_to_be_clickable((By.XPATH, "//button[@class='ChildRoomsList-bookButtonInput'][@data-selenium='ChildRoomsList-bookButtonInput']")))
        self.day_locator.click()
        print("Hotel Booked")
        self.payment_page = self.wait.until(EC.element_to_be_clickable(
            (By.XPATH, "//button[@class='Buttonstyled__ButtonStyled-sc-5gjk6l-0 kQOJVT sc-pZOBi gagPGR']")))
        self.payment_page.click()
        print("Payment page")
        self.driver.switch_to.frame(0)
        self.driver.find_element(By.XPATH,
                                 "//div[@class='Box-sc-kv6pi1-0 Selectstyled__SelectHeader-sc-1vfjv54-0 doiZyA Box-sc-kv6pi1-0 iSZIoo'][@tabindex='0']").click()
        self.driver.find_element(By.ID, "cardNumber").send_keys("2435263748595674")
        self.driver.find_element(By.ID, "expiryDate").send_keys("1225")
        self.driver.find_element(By.ID, "cvv").send_keys("177")
        self.driver.find_element(By.ID, "issuingBank").send_keys("SBI")
        self.driver.find_element(By.XPATH,
                                 "//select[@class='Selectstyled__StyledSelect-sc-h8hbk-0 eAcHDu kite-js-Select ']").click()
        print("Payment Page Details Successfully Filled")
