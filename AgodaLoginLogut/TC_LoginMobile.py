...
class LoginMobile(unittest.TestCase):
    def setUp(self):
    ...
    def test_LoginLogout(self):
        ...
        self.driver.find_element(By.XPATH, "//span[@data-cy='phone_tab']").click()
        self.driver.find_element(By.ID, "phone").send_keys("7200907966")
        self.driver.find_element(By.ID, "password").send_keys("Jesus@777")
        self.driver.find_element(By.XPATH, "//button[@data-cy='signin-button']").click()
        ...
        try:
            ...
            time.sleep(2)
        self.signout_header = self.driver.find_element(By.XPATH,
                                                       "//div[@class='UserMenustyled__UserMenuDisplay-sc-14cll85-1 hJSdLP'][@data-element-name='user-menu']")
        self.signout_header.click()
        self.driver.find_element(By.XPATH,
                                 "//button[@class='Buttonstyled__ButtonStyled-sc-5gjk6l-0 jxFsnW'][@data-element-name='sign-out-btn']").click()
